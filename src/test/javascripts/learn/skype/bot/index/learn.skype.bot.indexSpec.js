describe("learn.skype.bot.index", function() {

    var $rootScope, $state, $location;

    beforeEach(angular.mock.module('learn.skype.bot.index', function() {
    ...
    beforeEach(angular.mock.inject(function (_$rootScope_, $templateCache, _$state_, _$location_) {
        ...
        $templateCache.put('/learn/skype/bot/index/index.html', '');
    }));
